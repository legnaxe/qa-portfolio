...
До перехода в QA я 3+ года работала с данными и процессами. Это дало мне:

**UAT и аналитика:**
- Проводила пользовательское тестирование модуля автоматизации оплат: составляла сценарии, фиксировала несоответствия ТЗ, контролировала исправления.
- Результат: функция внедрена, ручной труд сокращен, ROI обоснован перед руководством.

**Работа с данными и багами:**
- Ежеквартально анализировала оплаты 30+ филиалов, сверяла SAP CRM и первичку.
